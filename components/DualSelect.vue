  ...
  <div class="grid items-center gap-1.5" style="grid-template-columns: 1fr 36px 1fr;">
    <div>
      ...
      <select
        ...
        multiple
        @dblclick="dblLeft"
        :class="['w-full rounded-lg border border-gray-300 bg-white px-2 py-1 text-sm text-gray-700 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary', height]"
      >
